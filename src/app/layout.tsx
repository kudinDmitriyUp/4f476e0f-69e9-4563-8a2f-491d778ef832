...
export const metadata: Metadata = {
  title: "Luxe Hotel - Premium 5-Star Accommodations",
  description: "Experience luxury hospitality at Luxe Hotel. Book your stay in our premium rooms, suites, and enjoy world-class amenities.",
  keywords: ["luxury hotel", "accommodations", "resort", "spa", "fine dining", "premium rooms"],
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Luxe Hotel - Premium 5-Star Accommodations",
    description: "Experience the ultimate in comfort and hospitality. Book your perfect stay today.",
    siteName: "Luxe Hotel",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764102457361-c32205hb.jpg",
  ...
  twitter: {
    ...
    title: "Luxe Hotel - Premium 5-Star Accommodations",
    description: "Book your luxury hotel stay. Premium rooms, spa, fine dining, and world-class service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764102457361-c32205hb.jpg"],
  },
};
